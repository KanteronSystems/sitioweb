jQuery(function(t) {
    var e = function() {
        ...
        i.prototype.send = function(n, i) {
            ...
            return i && (i.call(this, o),
            "pending" != o.state()) ? o : (a(e, {
                type: "POST",
                data: JSON.stringify({
      ...
      , a = function(e) {
        ...
        var a = !0
          , n = t(e).val()
          , r = t(e).attr("type")
        return n ? a = !("email" === r && !/^([^@]+?)@(([a-z0-9]-*)*[a-z0-9]+\.)+([a-z0-9]+)$/i.test(n)) : t(e).attr("required") && (a = !1),
        t(e)[(a ? "remove" : "add") + "Class"]("form-invalid"),
        a
    }
    t('[data-form-type="formoid"]').each(function() {
        ...
        c = o.attr("data-success") || o.find("[data-form-alert-success]").html() || o.html();

        l.html('<span class="btn-txt">' + l.html() + '</span><i class="btn-loader"></i>').click(function() {
        ...
        i.submit(function(d) {
            ...
            !l.hasClass("btn-loading")) {
                ...
                f && (l.addClass("btn-loading").prop("disabled", !0),
                n.send(u).done(function(e) {
                    i.removeClass("form-active");
                    r.find("[data-form-field]").val("");
                    if (o.is('.alert')) {
                        o.find('.alert').removeAttr('hidden');
                        o.text(c || e);
                    } else {
